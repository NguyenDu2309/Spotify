...
const SongItem: React.FC<SongItemProps> = ({
  ...
  return (
    <div onClick={() => onClick(data.id)}
      className="group relative gruop flex flex-col items-center rounded-md justify-center overflow-hidden gap-x-4 bg-neutral-400/5 cursor-pointer hover:bg-neutral-400/10 transition p-3">
